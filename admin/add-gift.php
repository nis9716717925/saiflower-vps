...
<title>Add New Gift | Admin</title>
...
<p style="color:#666;margin-bottom:30px;">Add a fresh gift to your online store.</p>

<form action="actions/add_gift.php" method="POST" enctype="multipart/form-data">
<?php csrf_field(); ?>
...
<div class="slug-note">Final URL: /gifts/<span id="slugPreview" style="color:var(--primary); font-weight:bold;">your-slug</span></div>
...
<textarea name="description" placeholder="Describe the gift..." required style="min-height:120px;"></textarea>

<label>Image Alt Text (SEO)</label>
<input type="text" name="image_alt" placeholder="e.g. Romantic gift hamper with chocolates and roses">
...
<input type="text" name="meta_title" placeholder="Gift name + City name">
...
function addFaqRow(q = '', a = '') {
    ...
    qInput.placeholder = 'Question (e.g., Can I include a personal message?)';
    ...
    aInput.placeholder = 'Answer (e.g., Yes, you can add a note at checkout.)';
