  ...
  async (req: AuthRequest, res, next) => {
    try {
      const result = await orderService.placeOrder({
        ...
        midnight_fee: req.body.midnight_fee != null ? Number(req.body.midnight_fee) : undefined,
        deliver_now: Boolean(req.body.deliver_now),
        slot_mode: req.body.slot_mode === 'custom' ? 'custom' : 'hourly',
        custom_delivery_time: req.body.custom_delivery_time,
